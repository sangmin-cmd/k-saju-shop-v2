  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* 뒤로가기 */}
        <Link href="/products" className="inline-flex items-center text-gray-600 hover:text-primary-500 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* 왼쪽: 이미지 */}
          <div>
            <div className="relative h-96 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl flex items-center justify-center mb-6">
              {product.badge && (
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm font-semibold">즉시 발송</div>
                <div className="text-xs text-gray-500">결제 후 24시간</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="text-2xl mb-1">🔒</div>
                <div className="text-sm font-semibold">정보 보안</div>
                <div className="text-xs text-gray-500">암호화 처리</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="text-2xl mb-1">♻️</div>
                <div className="text-sm font-semibold">환불 보장</div>
          ...
          <div>
            ...
            {/* 포함 내용 */}
            <div className="mb-8">
              <h2 className="text-xl font-bold mb-4">📋 포함 내용</h2>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-8">
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-lg">{product.pages}페이지</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {product.category === 'basic' && (
                <>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    ...
                    <h3 className="font-bold mb-2">처음 사주를 보는 분</h3>
                    <p className="text-sm text-gray-600">기본적인 사주 분석을 합리적인 가격으로 경험하고 싶은 분</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="text-3xl mb-3">📊</div>
                    <h3 className="font-bold mb-2">2026년 운세가 궁금한 분</h3>
                    <p className="text-sm text-gray-600">내년 전체 흐름과 월별 운세를 미리 알고 싶은 분</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="text-3xl mb-3">💰</div>
                    <h3 className="font-bold mb-2">가성비를 중요하게 생각하는 분</h3>
              ...
              {product.category === 'compatibility' && (
                <>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="text-3xl mb-3">💕</div>
                    <h3 className="font-bold mb-2">연인/배우자와의 궁합이 궁금한 분</h3>
                    <p className="text-sm text-gray-600">두 사람의 케미와 앞으로의 관계를 알고 싶은 분</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="text-3xl mb-3">💔</div>
                    <h3 className="font-bold mb-2">관계 개선이 필요한 분</h3>
                    <p className="text-sm text-gray-600">갈등 해결과 화해 방법을 구체적으로 알고 싶은 분</p>
                  </div>
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="text-3xl mb-3">💌</div>
                    <h3 className="font-bold mb-2">썸 중이거나 고백 준비 중인 분</h3>
